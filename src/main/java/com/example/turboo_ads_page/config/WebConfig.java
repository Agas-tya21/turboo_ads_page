...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/api/**") // Menerapkan CORS pada semua endpoint di bawah /api/
                .allowedOrigins("http://192.168.18.43:3000", "http://192.168.215.192:3000", "http://localhost:3000") // Mengizinkan semua domain. Ganti dengan domain frontend Anda untuk produksi.
